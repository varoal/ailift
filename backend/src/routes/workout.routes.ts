...
export const workoutRouter = (dataSource: DataSource) => {
  ...
  workoutRouter.post(
    "/start/:routineId",
    authMiddleware,
    workoutController.startWorkout.bind(workoutController)
  );

  workoutRouter.get(
    "/active",
    authMiddleware,
    workoutController.getActiveWorkout.bind(workoutController)
  );
  ...
  workoutRouter.get(
    "/user/:userId",
    workoutController.getWorkoutsByUserId.bind(workoutController)
  );
  ...
  workoutRouter.post(
    "/finish/:id",
    authMiddleware,
    workoutController.finishWorkout.bind(workoutController)
  );

  workoutRouter.post(
    "/sets/done/:setId",
    authMiddleware,
    workoutController.markSetAsDone.bind(workoutController)
  );

  workoutRouter.post(
    "/sets/undone/:setId",
    authMiddleware,
    workoutController.markSetAsUndone.bind(workoutController)
  );

  workoutRouter.post(
    "/sets/add/:workoutExerciseId",
    authMiddleware,
    workoutController.addSetToExercise.bind(workoutController)
  );

  workoutRouter.delete(
    "/sets/:setId",
    authMiddleware,
    workoutController.deleteSet.bind(workoutController)
  );
