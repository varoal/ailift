...
export const routineExerciseRouter = (dataSource: DataSource) => {
  ...
  routineExerciseRouter.get(
    "/:id",
    routineExerciseController.getRoutineExerciseById.bind(
  ...
  routineExerciseRouter.get(
    "/routine/:routineId",
    routineExerciseController.getRoutineExercisesByRoutineId.bind(
      routineExerciseController
    )
  );
  ...
  routineExerciseRouter.post(
    "/",
    authMiddleware,
    routineExerciseController.createRoutineExercise.bind(
      routineExerciseController
    )
  );

  routineExerciseRouter.put(
    "/:id",
    authMiddleware,
    routineExerciseController.updateRoutineExercise.bind(
      routineExerciseController
    )
  );
  
  routineExerciseRouter.delete(
    "/:id",
    authMiddleware,
    routineExerciseController.deleteRoutineExercise.bind(
      routineExerciseController
    )
  );
